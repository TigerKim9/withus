...
<link rel="stylesheet" href="${pageContext.request.contextPath }/CSS/fundpage.css">
...
<body>
	...
	<div id="projectGrid" class="grid grid-cols-3 gap-16 px-32">
		...
		<c:set var="length" value="${fn:length(category) }"></c:set>
		<c:choose>
		<c:when test="${!(empty length || length==0)}">
